...
ClambHook is distributed from `store.clambercloud.com`. Purchases, renewals, and
license device management happen on `store.swiphtgroup.com`.
...
- A 7-day free trial starts at first launch.
